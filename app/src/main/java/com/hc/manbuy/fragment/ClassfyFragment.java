...
import com.hc.manbuy.AppConstans;
import com.hc.manbuy.R;
import com.hc.manbuy.activity.ZxingActivity;
import com.hc.manbuy.adapter.ClassFirstRecylerAdapter;
import com.hc.manbuy.adapter.ClassGridAdapter;
import com.hc.manbuy.base.BaseFragment;
import com.hc.manbuy.bean.Bean;
import com.hc.manbuy.bean.ClassBeanFirst;
import com.hc.manbuy.bean.ClassBeanSecond;
import com.hc.manbuy.utils.CustomGridView;
import com.hc.manbuy.utils.ItemDecration;
import com.hc.manbuy.utils.OkHttpUtils;
 ...
 * 时间 : 2017/9/4 9:54
 */
public class ClassfyFragment extends BaseFragment implements View.OnClickListener{
    ...
    */
    private void gridData() {
        for (final Bean b : class_Title) {
            ...
            OkHttpUtils.getInstance().getBeanOfOk(getActivity(), AppConstans.CLASSFY_BASE.BASE_CLASSFY_EXPAND_URL + b.id, ClassBeanSecond.class,
                    new OkHttpUtils.CallBack<ClassBeanSecond>() {
                        @Override
                        public void getData(ClassBeanSecond testBean) {
                            if (testBean != null) {
